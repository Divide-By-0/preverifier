...
const verifierContract = new Contract(verifierAbi, '0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAe');
verifierContract.deploy({ data: verifierBytecode });
const pairingContract = new Contract(pairingAbi, '0xde0B295669a9FD93d5F28D9Ec85E40f4cb697BAf');
...
messageValidatorBytecode = linker.linkBytecode(messageValidatorBytecode, { Verifier: '', Pairing: '[LIBRARY_ADDRESS]' });
